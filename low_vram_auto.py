...
def main():
    ...
    output_dir = "text"
    output_file = os.path.join(output_dir, "mplug3_output_low_vram.txt")
    ...
    print("Loading 4-bit quantized model with adaptive device mapping...")
    ...
    print("Model and processor initialized successfully. Starting adaptive inference loop...")
    ...
    print("Adaptive batch processing completed successfully.")
